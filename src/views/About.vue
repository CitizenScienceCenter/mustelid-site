<i18n>
{
  ...
  "paragraph-3-3": "Langzeitüberwachungen von Wieseln und deren Beutepopulationen sind daher sehr wichtig für den Naturschutz. Solche Monitorings sind aber sehr aufwendig und oft nur mit der Unterstützung von vielen Freiwilligen möglich. Die Kontrolle der Fotofallenboxen wird in diesem Projekt vor allem durch Freiwillige durchgeführt. Vielen Dank an alle, die sich für das Projekt engagieren!",

  "subheading-4": "Was kann ich tun?",
  "paragraph-4-1": "Im Verlauf des Jahres haben wir an verschiedenen Standorten Videos von den tierischen Besuchern dieser Fotofallenboxen gemacht und können diese alle alleine niemals durchschauen. Deshalb sind wir auf Ihre Hilfe angewiesen. Helfen Sie uns herauszufinden, wer die Boxen besucht.",
  ...
  "paragraph-1-2": "In this project, we want to find out where weasels occur in the Swiss Midlands. We are also interested in whether the species composition of the prey differs between locations and whether this has an influence on the occurrence of weasels.",
  ...
  "subheading-4": "What Can I do?",
  "paragraph-4-1": "In the course of the year we have made innumerable videos of the animals visiting these camera trap boxes at different locations. Alone we will never be able to look through them all. Therefore we are dependent on your help. Help us find out who is visiting the boxes.",
  "paragraph-4-1-button": "To the Videos",
  ...
  "paragraph-4-3": "The project is supported by:",
...
<template>
  <div>
    ...
    <section-feedback email="help@citizenscience.ch" :subject="$t('site-name')" color="light-greyish"></section-feedback>
